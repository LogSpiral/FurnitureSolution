...
internal sealed class SolutionItemCrossMod(Mod mod, string name, string texturePath) : SolutionItemBase(mod.Find<ModProjectile>($"{name}SolutionProjectile").Type)
{
